...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MaterialButton buttonDivide,buttonMultiply,buttonPlus,buttonSubtrack,buttonEquals;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignId(buttonPlus,R.id.button_plush);
        assignId(buttonSubtrack,R.id.button_subtract);
